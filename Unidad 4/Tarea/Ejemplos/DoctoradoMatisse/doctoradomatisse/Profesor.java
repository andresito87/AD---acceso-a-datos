 ...
 * Generation date: Fri Feb 28 15:56:37 2025
 */
...
public class Profesor extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("doctoradomatisse.Profesor"));
     ...
     * @see #removeDirige
     */
    public final doctoradomatisse.Tesis[] getDirige() {
        return (doctoradomatisse.Tesis[])getSuccessors(getDirigeRelationship(getMtDatabase()), doctoradomatisse.Tesis.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> dirigeIterator() {
        return this.<E>successorIterator(getDirigeRelationship(getMtDatabase()), doctoradomatisse.Tesis.class);
    }
     ...
     * @see #removeDirige
     */
    public final void setDirige(doctoradomatisse.Tesis[] succs) {
     ...
     * @see #removeDirige
     */
    public final void prependDirige(doctoradomatisse.Tesis succ) {
     ...
     * @see #dirigeIterator
     */
    public final void appendDirige(doctoradomatisse.Tesis succ) {
     ...
     * @see #dirigeIterator
     */
    public final void appendDirige(doctoradomatisse.Tesis[] succs) {
     ...
     * @see #dirigeIterator
     */
    public void removeDirige(doctoradomatisse.Tesis[] succs) {
     ...
     * @see #dirigeIterator
     */
    public void removeDirige(doctoradomatisse.Tesis succ) {
     ...
     * @see #clearPertenece
     */
    public final doctoradomatisse.Departamento getPertenece() {
        return (doctoradomatisse.Departamento)getSuccessor(getPerteneceRelationship(getMtDatabase()));
    }
     ...
     * @see #clearPertenece
     */
    public final void setPertenece(doctoradomatisse.Departamento succ) {
