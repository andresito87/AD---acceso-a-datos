...
public class ComponenteMiTextoBeanInfo extends SimpleBeanInfo {
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_tipo] = new PropertyDescriptor ( "tipo", misControles.ComponenteMiTexto.class, "getTipo", "setTipo" ); // NOI18N
            properties[PROPERTY_tipo].setPropertyEditorClass ( misControles.tipoPropertyEditor.class );
